...
package com.bukowiecki.breakpoints.model.python
 ...
 */
open class PythonLineImportableBreakpointImpl(
    project: ProjectWrapper,
    typeID: String,
    state: LineBreakpointState<*>,
    breakpointMetadata: BreakpointMetadata
) : ImportableBreakpointImpl<LineBreakpointState<*>, XBreakpointProperties<*>>(project, typeID, state, null, breakpointMetadata)